...
class SetCommaIntegerTypeHandlerTest extends BaseTypeHandlerTest {
    ...
    void setParameterTest() throws SQLException {
        typeHandler.setParameter(ps, 1, new TreeSet<>(Set.of(3, 1)), null);
        verify(ps).setString(1, "1,3");
    }
    ...
    public void getNullableResultByNameTest() throws SQLException {
        ...
        Set<Integer> ids2 = typeHandler.getResult(rs, "ids2");
        assertTrue(ids2.isEmpty());

        when(rs.getString("ids3")).thenReturn("1,1,2,3");
        Set<Integer> ids3 = typeHandler.getResult(rs, "ids3");
    ...
    public void getNullableResultByIndexTest() throws SQLException {
        ...
        Set<Integer> ids2 = typeHandler.getResult(rs, 1);
        assertTrue(ids2.isEmpty());

        when(rs.getString(1)).thenReturn("1,1,2,3");
        Set<Integer> ids3 = typeHandler.getResult(rs, 1);
        assertArrayEquals(new Integer[]{1, 2, 3}, ids3.toArray(new Integer[0]));
    }
    ...
    public void getNullableResultCallableStatementTest() throws SQLException {
        ...
        Set<Integer> ids2 = typeHandler.getResult(cs, 1);
        assertTrue(ids2.isEmpty());

        when(cs.getString(1)).thenReturn("1,1,2,3");
        Set<Integer> ids3 = typeHandler.getResult(cs, 1);
        assertArrayEquals(new Integer[]{1, 2, 3}, ids3.toArray(new Integer[0]));
    }
}
