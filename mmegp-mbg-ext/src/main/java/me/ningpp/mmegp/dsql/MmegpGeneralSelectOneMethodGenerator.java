...
// copy code from GeneralSelectOneMethodGenerator
public class MmegpGeneralSelectOneMethodGenerator extends AbstractMethodGenerator {
    private final FullyQualifiedJavaType recordType;

    private MmegpGeneralSelectOneMethodGenerator(Builder builder) {
        super(builder);
    ...
    public MethodAndImports generateMethodAndImports() {
        ...
        method.addBodyLine(String.format(Locale.ROOT,
                "return MyBatis3Utils.selectOne(this::selectOne, %s, %s, completer);",
    ...
    public static class Builder extends BaseBuilder<Builder> {
        ...
        public MmegpGeneralSelectOneMethodGenerator build() {
            return new MmegpGeneralSelectOneMethodGenerator(this);
        }
    }
}
